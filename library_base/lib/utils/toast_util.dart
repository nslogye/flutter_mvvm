  ...
  static void waring(String msg,
    ...
    Widget widget = Container(
        ...
        child: Row(
            ...
            children: <Widget>[
              const Icon(Icons.warning, color: Colours.white, size: 25),
              ConstrainedBox(
                  constraints: BoxConstraints(
                      maxWidth: ScreenUtil.instance().screenWidth - 160),
                  child: Padding(
                      ...
                      child: Text(msg,
                          ...
                          style: const TextStyle(
                              fontSize: 15, color: Colours.white))))
            ]));

    showToastWidget(widget, duration: duration, position: position);
  }
  ...
  static void error(String msg,
    ...
    Widget widget = Container(
        ...
        child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              const Icon(Icons.error, color: Colours.white, size: 25),
              ConstrainedBox(
                  constraints: BoxConstraints(
                      maxWidth: ScreenUtil.instance().screenWidth - 160),
                  child: Padding(
  ...
  static void success(String msg,
    ...
    Widget widget = Container(
        ...
        child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              const Icon(Icons.check, color: Colours.white, size: 25),
              ConstrainedBox(
                  constraints: BoxConstraints(
                      maxWidth: ScreenUtil.instance().screenWidth - 160),
                  child: Padding(
    ...
    Widget widget = Container(
      ...
      child: ClipRect(
        child: Text(
          ...
          style: const TextStyle(fontSize: 15, color: Colours.text_black),
        ),
      ),
    );
