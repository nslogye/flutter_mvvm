...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "appName": MessageLookupByLibrary.simpleMessage("flutter_mvvm"),
    ...
    "notSetPassword": MessageLookupByLibrary.simpleMessage(
      "该账户未设置登录密码\n可使用短信验证码登录",
    ),
    "notSetPasswordTips": MessageLookupByLibrary.simpleMessage(
      "（登录后可在账户与安全中设置密码）",
    ),
    "oldPassword": MessageLookupByLibrary.simpleMessage("原密码"),
    "otc": MessageLookupByLibrary.simpleMessage("OTC"),
    ...
    "passwordHintTips": MessageLookupByLibrary.simpleMessage("8~20位数字、字母、符号组合"),
