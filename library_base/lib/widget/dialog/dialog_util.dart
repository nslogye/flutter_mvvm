...
class DialogUtil {
  static void showCupertinoAlertDialog(BuildContext context,
    ...
    if (ObjectUtil.isNotEmpty(cancel)) {
      actions.add(CupertinoDialogAction(
          child: Text(cancel!,
              style: TextStyle(fontSize: 17, color: Colours.gray_500)),
    ...
    if (ObjectUtil.isNotEmpty(confirm)) {
      actions.add(CupertinoDialogAction(
          child: Text(confirm!,
              style: TextStyle(fontSize: 17, color: Colours.app_main)),
        ...
        builder: (BuildContext context) {
          return CupertinoAlertDialog(
              title: ObjectUtil.isEmpty(title)
                  ? null
                  : Text(title!,
                      style: TextStyle(fontSize: 17, color: Colours.gray_800)),
  ...
  static void showShareImageDialog(BuildContext context,
