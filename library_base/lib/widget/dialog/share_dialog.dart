...
class ShareDialog extends StatelessWidget {
    ...
    if (children == null) {
      ...
      if (DeviceUtil.isAndroid) {
        ...
        if (ObjectUtil.isNotEmpty(result)) {
          File saveFile =
              new File(result['filePath']?.replaceAll("file://", ""));
  ...
  Future<void> _shareWechat(BuildContext context, WeChatScene scene) async {
    ...
    if (children == null) {
      Fluwx().share(WeChatShareWebPageModel("", scene: scene));
      ...
      Fluwx().share(WeChatShareImageModel(
          WeChatImageToShare(uint8List: pngBytes),
          scene: scene));
            ...
            Container(
              ...
              child: IntrinsicHeight(
                ...
                children: children == null
                    ? [shareWechat, shareFriend, shareMore]
                    : [shareWechat, shareFriend, shareSave, shareMore],
              )),
            ),
            TextButton(
