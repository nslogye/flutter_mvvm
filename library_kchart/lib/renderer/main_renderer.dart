...
import 'package:library_kchart/entity/candle_entity.dart';
import 'package:library_kchart/k_chart_widget.dart' show MainState;
...
class MainRenderer extends BaseChartRenderer<CandleEntity> {
  ...
  MainRenderer(Rect? mainRect, double maxValue, double minValue,
    ...
    var newScaleY =
        (chartRect!.height - _contentPadding) / diff; //内容区域高度/差=新的比例
...
//    //画阴影
    ...
    canvas.drawPath(mLinePath!,
        mLinePaint..strokeWidth = (mLineStrokeWidth / scaleX!).clamp(0.3, 1.5));
    mLinePath!.reset();
  }
  ...
  void drawGrid(Canvas canvas, int gridRows, int gridColumns,
      {bool showRows = true, bool showColumns = true}) {
