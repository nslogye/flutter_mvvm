 ...
 * @LastEditTime: 2025-06-11 20:35:08
 * @FilePath: /flutter_mvvm/library_kchart/lib/renderer/vol_renderer.dart
...
class VolRenderer extends BaseChartRenderer<VolumeEntity> {
  ...
  void drawText(Canvas canvas, VolumeEntity data, double x) {
    TextSpan span = TextSpan(
      children: [
        TextSpan(
            text: "VOL:${KChartNumberUtil.volFormat(data.vol!)}    ",
  ...
  void drawRightText(canvas, textStyle, int gridRows) {
    TextSpan span =
        TextSpan(text: KChartNumberUtil.volFormat(maxValue), style: textStyle);
    TextPainter tp = TextPainter(text: span, textDirection: TextDirection.ltr);
    tp.layout();
    tp.paint(canvas,
