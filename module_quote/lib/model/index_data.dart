...
class IndexData {
  ...
  IndexData.fromJson(Map<String, dynamic> jsonMap) {
    ...
    pair = jsonMap['pair'] ?? '';
    address_balance_list =
        AssetsDistribution.fromJsonList(jsonMap['address_balance_list']) ?? [];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> jsonMap = <String, dynamic>{};
    jsonMap['turnover'] = turnover;
    jsonMap['turnover_market_vol'] = turnover_market_vol;
    jsonMap['total_supply'] = total_supply;
    jsonMap['total_supply_market_vol'] = total_supply_market_vol;
    jsonMap['address_count'] = address_count;
    jsonMap['update_time'] = update_time;
    jsonMap['pair'] = pair;
    jsonMap['address_balance_list'] =
        address_balance_list?.map((v) => v.toJson()).toList();
...
class AssetsDistribution {
  ...
  Map<String, dynamic> toJson() {
    ...
    jsonMap['range'] = range;
    jsonMap['address_count'] = address_count;
    jsonMap['compare_yesterday_ratio'] = compare_yesterday_ratio;
