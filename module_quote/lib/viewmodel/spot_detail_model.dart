...
class SpotDetailModel extends ViewStateModel {
  ...
  SpotDetailModel(List<String> titles) : super(viewState: ViewState.first) {
...
class SpotKLineHandleModel extends ViewStateModel {
  SpotKLineHandleModel() : super(viewState: ViewState.first) {}
}

class SpotHeaderModel extends ViewStateModel {
  SpotHeaderModel() : super(viewState: ViewState.first) {}
}
