...
class SpotKlineModel extends ViewStateModel {
  ...
  SpotKlineModel(this.keyChart) : super(viewState: ViewState.first) {
  ...
  Future getQuote(String chain, int index) {
    ...
    // return DioUtil.getInstance()!.requestNetwork(Apis.URL_GET_QUOTE, 'get',
...
class SpotKlineTabModel extends ViewStateModel {
  SpotKlineTabModel() : super(viewState: ViewState.first) {}
}
