...
class IndexPlatformPage extends StatefulWidget {
  ...
  @override
  IndexPlatformPageState createState() => IndexPlatformPageState();
}

class IndexPlatformPageState extends State<IndexPlatformPage>
    with
        BasePageMixin<IndexPlatformPage>,
        AutomaticKeepAliveClientMixin<IndexPlatformPage>,
        SingleTickerProviderStateMixin {
  @override
  bool get wantKeepAlive => true;

  final ShotController _shotController = ShotController();
              ...
              GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text.rich(TextSpan(children: [
                      ...
                      WidgetSpan(
                          child: SortButton(
                              state: _quoteModel.sortState ==
                                      IndexPlatformSortState.PRICE_ASCEND
                                  ? SortButtonState.assuper
                                  : _quoteModel.sortState ==
                                          IndexPlatformSortState.PRICE_DESCEND
                  ...
                  child: Container(
                    ...
                    child: Text.rich(TextSpan(children: [
                      ...
                      WidgetSpan(
                          child: SortButton(
                              state: _quoteModel.sortState ==
                                      IndexPlatformSortState.RATE_ASCEND
                                  ? SortButtonState.assuper
                                  : _quoteModel.sortState ==
                                          IndexPlatformSortState.RATE_DESCEND
                                      ? SortButtonState.descend
                                      : SortButtonState.normal))
                    ])),
                  ))
