...
class SpotDetailHPage extends StatefulWidget {
  ...
  SpotDetailHPage({Key? key, this.coinCode = 'bitcoin', this.quoteCoin})
      : super(key: key);
...
class _SpotDetailHPageState extends State<SpotDetailHPage>
    with BasePageMixin<SpotDetailHPage>, SingleTickerProviderStateMixin {
    ...
    return ProviderWidget<SpotDetailModel>(
        ...
        builder: (context, model, child) {
          return model.isFirst
              ? Container(color: Colours.gray_100, child: FirstRefresh())
              : Scaffold(
                            ...
                            builder: (context, model, child) {
                              return SpotDetailHAppbar(
                                  ...
                                  numberSlideController:
                                      _spotDetailModel.quoteSlideController);
                            }),
                        Expanded(
                            child: SpotKlineHBar(
