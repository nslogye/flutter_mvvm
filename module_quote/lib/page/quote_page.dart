...
import 'package:module_quote/page/platform_list_page.dart';
...
class QuotePageState extends State<QuotePage>
    with
        BasePageMixin<QuotePage>,
        AutomaticKeepAliveClientMixin<QuotePage>,
          ...
          Container(
            ...
            child: TabBar(
              ...
              indicator: RoundTabIndicator(
                  borderSide:
                      const BorderSide(color: Colours.app_main, width: 3),
                  isRound: true,
          ...
          Expanded(
            ...
            children: <Widget>[
              extended.NestedScrollViewInnerScrollPositionKeyWidget(
                  Key(_tabTitles[0]), IndexListPage(key: _keyList[0])),
              extended.NestedScrollViewInnerScrollPositionKeyWidget(
