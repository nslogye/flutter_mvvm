...
class IndexListPageState extends State<IndexListPage>
    with
        BasePageMixin<IndexListPage>,
        AutomaticKeepAliveClientMixin<IndexListPage>,
                                ...
                                delegate: SliverChildBuilderDelegate(
                                  (context, i) {
                                    return QuoteIndexItem(
                                        index: i, quoteIndex: sortedList[i]);
                                  },
              ...
              GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text.rich(TextSpan(children: [
                      ...
                      WidgetSpan(
                          child: SortButton(
                              state: _indexModel.sortState ==
                                      IndexSortState.PRICE_ASCEND
                                  ? SortButtonState.assuper
                                  : _indexModel.sortState ==
                                          IndexSortState.PRICE_DESCEND
                  ...
                  child: Container(
                    ...
                    child: Text.rich(TextSpan(children: [
                      ...
                      WidgetSpan(
                          child: SortButton(
                              state: _indexModel.sortState ==
                                      IndexSortState.RATE_ASCEND
                                  ? SortButtonState.assuper
                                  : _indexModel.sortState ==
                                          IndexSortState.RATE_DESCEND
                                      ? SortButtonState.descend
                                      : SortButtonState.normal))
                    ])),
                  ))
