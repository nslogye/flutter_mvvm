...
class PlatformPage extends StatefulWidget {
  ...
  @override
  PlatformPageState createState() => PlatformPageState();
}

class PlatformPageState extends State<PlatformPage>
    with
        BasePageMixin<PlatformPage>,
        AutomaticKeepAliveClientMixin<PlatformPage>,
            ...
            child: Theme(
              ...
              child: TabBar(
                ...
                indicator: const BubbleTabIndicator(
                  insets: EdgeInsets.only(left: 0, right: 12),
                ...
                tabs: <Tab>[
                  Tab(
                    ...
                    children: [
                      Gaps.hGap8,
                      const RoundImage(
                        'https://szwj-beacon.oss-cn-beijing.aliyuncs.com/backstage/coin_ico/20210421/c55936d515204c1b9eee64e2ddcbba5ficon-exchange-OKex.png',
                        width: 16,
                        height: 16,
                  ...
                  Tab(
                    ...
                    children: [
                      Gaps.hGap8,
                      const RoundImage(
                        'https://szwj-beacon.oss-cn-beijing.aliyuncs.com/backstage/coin_ico/20210421/9a81f06c4f6447eda18417a209cf3702icon-exchange-huobi.png',
                        width: 16,
                        height: 16,
                        borderRadius: BorderRadius.all(Radius.circular(0)),
                      ),
                  ...
                  Tab(
                    ...
                    children: [
                      Gaps.hGap8,
                      const RoundImage(
                        'https://szwj-beacon.oss-cn-beijing.aliyuncs.com/backstage/coin_ico/20210421/d673adfc7fc0432db082e7a0f7835909icon-exchange-bian.png',
                        width: 16,
                        height: 16,
                        borderRadius: BorderRadius.all(Radius.circular(0)),
                      ),
          ...
          Expanded(
            ...
            children: <Widget>[
              extended.NestedScrollViewInnerScrollPositionKeyWidget(
                  Key(_tabTitles[0]), PlatformListPage(key: _keyList[0])),
              extended.NestedScrollViewInnerScrollPositionKeyWidget(
                  Key(_tabTitles[1]), PlatformListPage(key: _keyList[1])),
              extended.NestedScrollViewInnerScrollPositionKeyWidget(
                  Key(_tabTitles[2]), PlatformListPage(key: _keyList[2])),
            ],
          ))
        ],
      ),
