...
class IndexBriefPage extends StatefulWidget {
  ...
  const IndexBriefPage({Key? key, this.coinCode}) : super(key: key);

  @override
  _IndexBriefPageState createState() => _IndexBriefPageState();
}

class _IndexBriefPageState extends State<IndexBriefPage>
    with
        BasePageMixin<IndexBriefPage>,
        AutomaticKeepAliveClientMixin<IndexBriefPage>,
                    ...
                    Container(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(S.of(context).moreLink,
                              style: TextStyles.textGray800_w700_14),
                        ),
                        GridView.builder(
                          shrinkWrap: true,
                      ...
                      child: Column(
                        children: [
                          Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  int index = widget.coinCode ==
                                          Apis.COIN_BITCOIN
                                      ? 1
                                      : widget.coinCode == Apis.COIN_ETHEREUM
                                          ? 2
                                          : 0;
                                  Routers.navigateTo(
                                      context, Routers.milestonePage,
                                      parameters: Parameters()
                                        ..putInt('initialIndex', index));
                                },
                                child: Row(
                                  children: [
                                    Expanded(
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return MileStoneItem(
                                ...
                                time: mileStone.date ?? '',
                                isLast: index ==
                                    (min(model.milestoneList.length, 3) - 1),
                              );
                            },
