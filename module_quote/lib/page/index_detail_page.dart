...
class IndexDetailPage extends StatefulWidget {
  ...
  const IndexDetailPage({super.key, this.coinCode = 'bitcoin'});
...
class IndexDetailPageState extends State<IndexDetailPage>
    with BasePageMixin<IndexDetailPage>, SingleTickerProviderStateMixin {
  ...
  Future<void> _refresh() {
    return _indexDetailModel.getSpotDetailWithChild(
  ...
  Future<void> _share() async {
    ...
    Future.delayed(new Duration(milliseconds: 100), () async {
      ...
      Uint8List tabViewpngBytes =
          await _indexDetailModel.keyList[0].currentState!.screenShot()!;
      ...
      DialogUtil.showShareDialog(context, children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              IndexDetailShareBar(
                  showShadow: false, quoteCoin: _indexDetailModel.quoteCoin),
    ...
    return ProviderWidget<IndexDetailModel>(
        ...
        builder: (context, model, child) {
          return model.isFirst
              ? Container(color: Colours.gray_100, child: const FirstRefresh())
              : Scaffold(
                                  ...
                                  children: <Widget>[
                                    extended
                                        .NestedScrollViewInnerScrollPositionKeyWidget(
                                            Key(_tabTitles![0]),
                                            IndexPlatformPage(
                                                key: _indexDetailModel
                                                    .keyList[0],
                                                coinCode: widget.coinCode)),
                                    extended
                                        .NestedScrollViewInnerScrollPositionKeyWidget(
                                            Key(_tabTitles![1]),
                                            Routers.generatePage(context,
                                                Routers.articleListPage,
          ...
          builder: (context, model, child) {
            return SliverAppBar(
              ...
              title: IndexDetailAppbar(
                  ...
                  numberSlideController:
                      _indexDetailModel.quoteSlideController),
              centerTitle: true,
              expandedHeight: 0,
    ...
    return ProviderWidget2(
        ...
        builder: (context, model1, model2, child) {
          ...
          String rateStr = (rate >= 0 ? '+' : '') +
              ...
              '%';
          String priceStr =
              NumUtil.getNumByValueDouble(price as double, 2).toString();
          ...
          return Column(
            ...
            children: [
              Container(
                  child: Text(
                title,
                style: TextStyles.textBlack16,
              )),
              _topBarExtentNofifier.value
                  ? Container(
