...
class _GlobalQuotePageState extends State<GlobalQuotePage>
    with BasePageMixin<GlobalQuotePage>, SingleTickerProviderStateMixin {
            ...
            Stack(
              children: [
                ...
                Container(
                  child: RotatedBox(
                    quarterTurns: 1,
                    child: GlobalQuoteShareBar(
                        btcUsdPair: _globalQuoteModel.btcUsdPair,
                        ethUsdPair: _globalQuoteModel.ethUsdPair),
                  ),
                ),
                Positioned(
                    bottom: 24,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            centerTitle: true,
            title:
                Text(S.of(context).globalQuote, style: TextStyles.textBlack16)),
        body: ProviderWidget<GlobalQuoteModel>(
            model: _globalQuoteModel,
            builder: (context, model, child) {
              String? package =
                  QuoteRouter.isRunModule ? null : Constant.moduleQuote;
                                            ...
                                            GridView.builder(
                                              ...
                                              itemBuilder: (_, index) {
                                                return GlobalQuoteItem(
                                                  index: index,
                                                  name: model
                                                      .quoteList[index].zh_name,
                                                  price: model.quoteList[index]
                                                      .quote as double,
                                                  change: model.quoteList[index]
                                                      .change_amount as double,
                                                  rate: model.quoteList[index]
                                                      .change_percent as double,
                                                );
                                              },
                                            ),
                                            Container(
