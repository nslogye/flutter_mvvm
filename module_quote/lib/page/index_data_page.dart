...
class _IndexDataPageState extends State<IndexDataPage>
    with
        WidgetsBindingObserver,
        BasePageMixin<IndexDataPage>,
        AutomaticKeepAliveClientMixin<IndexDataPage>,
          ...
          return model.isFirst
              ...
              : CommonScrollView(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () =>
                            Routers.navigateTo(context, Routers.treemapPage),
                        child: Container(
                          child: Column(
                            children: [
                              Container(
                                  margin:
                                      const EdgeInsets.fromLTRB(15, 18, 16, 9),
                                  height: 24,
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: Text(
                                            S.of(context).proAssetsCompare,
                                            style:
                                                TextStyles.textGray800_w700_18,
                                          ),
                                        ),
                                      ),
                                      Container(
                    ...
                    AssetsDistributionBar(
                        indexData: model.dataBasic, dataList: model.dataList),
                  ],
                );
        });
  }
