...
class SpotDetailAppbar extends StatefulWidget {
  ...
  @override
  SpotDetailAppbarState createState() => SpotDetailAppbarState();
}

class SpotDetailAppbarState extends State<SpotDetailAppbar> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    String rateStr = (rate >= 0 ? '+' : '') +
        NumUtil.getNumByValueDouble(rate as double, 2).toString() +
        '%';
    String priceStr = NumUtil.formatNum(price, point: 2);
    String priceCnyStr = NumUtil.formatNum(priceCny, point: 2);
    String changeAmountStr = (change_amount >= 0 ? '+' : '') +
        NumUtil.formatNum(change_amount, point: 2);
    ...
    String market_valStr =
        NumUtil.getBigVolumFormat(market_val.toDouble(), fractionDigits: 2)
            .toString();
    String amount24Str =
        NumUtil.getBigVolumFormat(amount_24h.toDouble(), fractionDigits: 2)
            .toString();
    String vol24Str =
        NumUtil.getBigVolumFormat(vol_24h.toDouble(), fractionDigits: 2)
            .toString();
              ...
              children: [
                ...
                Container(
                    ...
                    child: Text.rich(TextSpan(children: [
                      TextSpan(
                          text: '\$',
                          style: rate >= 0
                              ? TextStyles.textGreen_w400_12
                              : TextStyles.textRed_w400_12),
                      ...
                      WidgetSpan(
                        child: NumberSlide(
                            ...
                            textStyle: rate >= 0
                                ? TextStyles.textGreen_w400_22
                                : TextStyles.textRed_w400_22),
                      ),
                ...
                ProviderWidget<SpotHeaderModel>(
                    ...
                    builder: (context, model, child) {
                      ...
                      num priceCny = NumUtil.multiply(price, 6.5);
                      num change_amount =
                          spotDetailModel.quoteCoin?.change_amount ?? 0;

                      String rateStr = (rate >= 0 ? '+' : '') +
                          NumUtil.getNumByValueDouble(rate as double, 2)
                              .toString() +
                          '%';
                      String priceCnyStr =
                          NumUtil.formatNum(priceCny, point: 2);
                      String changeAmountStr = (change_amount >= 0 ? '+' : '') +
                          NumUtil.formatNum(change_amount, point: 2);
                          ...
                          children: [
                            Container(
                                ...
                                child: Text(
                                  rateStr,
                                  style: rate >= 0
                                      ? TextStyles.textGreen_w400_10
                                      : TextStyles.textRed_w400_10,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                )),
                            Gaps.hGap12,
...
class SpotDetailShareBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String rateStr =
        '${rate >= 0 ? '+' : ''}${NumUtil.getNumByValueDouble(rate as double, 2)}%';
    String priceStr = NumUtil.formatNum(price, point: 2);
    String priceCnyStr = NumUtil.formatNum(priceCny, point: 2);
    String changeAmountStr = (change_amount >= 0 ? '+' : '') +
        NumUtil.formatNum(change_amount, point: 2);
              ...
              children: [
                ...
                Container(
                    ...
                    child: Text.rich(TextSpan(children: [
                      ...
                      WidgetSpan(
                          child: rate >= 0
                              ? const LocalImage('arrow_up',
                                  package: Constant.baseLib,
                                  width: 10,
                                  height: 10)
                              : const LocalImage('arrow_down',
                                  package: Constant.baseLib,
                                  width: 10,
                                  height: 10))
                    ]))),
