...
class SpotKlineHBar extends StatefulWidget {
  ...
  const SpotKlineHBar(
      {Key? key, required this.coinCode, this.horizontal = false})
      : super(key: key);
...
class _SpotKlineHBarState extends State<SpotKlineHBar>
    with
        AutomaticKeepAliveClientMixin<SpotKlineHBar>,
  ...
  void initState() {
    ...
    _height = widget.horizontal
        ? double.infinity
        : max(295, ScreenUtil.instance().screenHeight * 0.5);
                            ...
                            children: [
                              ...
                              const Padding(
                                ...
                                child: SizedBox(
                                    ...
                                    height: 1.0,
                                    child: Divider(
                                        height: 1, color: Colours.gray_400)),
                              ),
                              CheckTextButton(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      volState =
                                          value ? VolState.VOL : VolState.NONE;
                                    });
                                  }),
                              CheckTextButton(
