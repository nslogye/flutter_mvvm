...
class _IndexTimelineBarState extends State<IndexTimelineBar>
    with
        AutomaticKeepAliveClientMixin<IndexTimelineBar>,
                              ...
                              : KLineChart(
                                  ...
                                  onLongPressChanged: (entity) {
                                    IndexDetailModel indexDetailModel =
                                        Provider.of<IndexDetailModel>(context,
                                            listen: false);
                                    indexDetailModel
                  ...
                  Container(
                    ...
                    child: TabBar(
                      ...
                      unselectedLabelStyle:
                          TextStyle(fontSize: 13, color: Colours.gray_500),
...
//              ),
                      ...
                      tabs: <KLineTab>[
                        KLineTab(
                            text: S.of(context).kline1h,
                            select: _tabController.index == 0),
                        KLineTab(
                            text: S.of(context).kline24h,
                            select: _tabController.index == 1),
                        KLineTab(
                            text: S.of(context).kline1week,
                            select: _tabController.index == 2),
                        KLineTab(
                            text: S.of(context).kline1month,
                            select: _tabController.index == 3),
                        KLineTab(
                            text: S.of(context).kline1year,
                            select: _tabController.index == 4),
                        KLineTab(
                            text: S.of(context).klineAll,
                            select: _tabController.index == 5),
                      ],
                      onTap: (index) {
