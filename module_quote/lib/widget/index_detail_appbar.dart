...
class IndexDetailAppbar extends StatefulWidget {
  ...
  @override
  IndexDetailAppbarState createState() => IndexDetailAppbarState();
}

class IndexDetailAppbarState extends State<IndexDetailAppbar> {
  @override
  void initState() {
    super.initState();
  }
          ...
          Container(
              ...
              child: Text.rich(TextSpan(children: [
                TextSpan(
                    text: '\$',
                    style: rate >= 0
                        ? TextStyles.textGreen_w400_14
                        : TextStyles.textRed_w400_14),
                ...
                WidgetSpan(
                  child: NumberSlide(
                      ...
                      textStyle: rate >= 0
                          ? TextStyles.textGreen_w400_30
                          : TextStyles.textRed_w400_30),
                ),
                TextSpan(text: ' ', style: TextStyle(fontSize: 11)),
                WidgetSpan(
                    child: rate >= 0
                        ? LocalImage('arrow_up',
                            package: Constant.baseLib, width: 11, height: 11)
                        : LocalImage('arrow_down',
                            package: Constant.baseLib, width: 11, height: 11))
              ]))),
          ProviderWidget<IndexHeaderModel>(
              ...
              builder: (context, model, child) {
                ...
                num priceCny = NumUtil.multiply(price, 6.5);
                num change_amount =
                    indexDetailModel.quoteCoin?.change_amount ?? 0;
...
class IndexDetailShareBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String changeAmountStr =
        (rate >= 0 ? '+' : '') + NumUtil.formatNum(change_amount, point: 2);
